...
<?php if ( have_comments() ) : ?>
    ...
    <div id="nicdark_comments" class="nicdark_section nicdark_margin_top_50">
		...
		<h3><strong><?php comments_number(esc_html__('No Comments','charityfoundation'),esc_html__('One Comment','charityfoundation'),esc_html__( '% Comments','charityfoundation') );?></strong></h3>

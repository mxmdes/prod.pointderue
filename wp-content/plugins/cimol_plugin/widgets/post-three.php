 ...
 * @since 1.1.0
 */
class Cimol_PostThree extends Widget_Base {
	...
	public function get_title() {
		return __( 'Cimol Post List Style 3', 'cimol_plg' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'width_warning',
					[
						'type' =>  Controls_Manager::RAW_HTML,
						'raw' => __( '<b>Note:</b> Make sure Image Area + Content Area width is 100%.', 'cimol_plg' ),
						'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning',
					]
		);
		...
		$this->add_responsive_control(
			'image_width',
			[
				'label' => __( 'Image Area Width (%)', 'cimol_plg' ),
		...
		$this->add_responsive_control(
			'content_width',
			[
				'label' => __( 'Content Area Width (%)', 'cimol_plg' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' =>0,
                        ...
                        if  ($settings['blog_column'] == 'three') {echo "col-md-4"; } if  ($settings['blog_column'] == 'four') {echo "col-md-3"; } ?>">
                        	<div class="blog-col-inner blog-style-three">
								<?php if ( has_post_thumbnail() ) { ?>
                                 ...
                                 <?php } else { ?>
                                 <a class="blog-link-img blog-imgbg" href="<?php the_permalink(); ?>" style="background-image:url(<?php echo CIMOL_URL ?>images/no-image.jpg)"> 
                                 	<div class="blogmask"></div>
                                 </a>
                                 <?php } ?>

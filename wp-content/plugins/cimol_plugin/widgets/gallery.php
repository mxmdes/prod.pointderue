 ...
 * @since 1.1.0
 */
class Cimol_Gallery extends Widget_Base {
	...
	public function get_name() {
		return 'cimol-gallery';
	}
	
	public function get_script_depends() { return [ 'jquery-magnific-popup','cimol-gallery-popup' ]; }
	...
	public function get_title() {
		return __( 'Cimol Gallery', 'cimol_plg' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			'gallery_height',
			[
				'label' => __( 'Gallery Item Height', 'cimol_plg' ),
	...
	protected function render() {
		...
		<div class="cimol-gallery clearfix">
